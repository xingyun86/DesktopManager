	...
	: CDialogEx(IDD_DESKTOPMANAGER_DIALOG, pParent)
{
	...
	/*m_strBrowserList = {
		LinkItem(0,TEXT("360SE.EXE"),{0}),//360ä¯ÀÀÆ÷    
		LinkItem(0,TEXT("IEXPLORE.EXE"),{0}),//IEä¯ÀÀÆ÷    
		LinkItem(0,TEXT("FIREFOX.EXE"),{0}),//»ðºü    
		LinkItem(0,TEXT("OPERA.EXE"),{0}),//Opera    
		LinkItem(0,TEXT("MAXTHON.EXE"),{0}),//åÛÓÎ    
		LinkItem(0,TEXT("LOCAL SET"),{0}),//Google    
		LinkItem(0,TEXT("THEWORLD.EXE"),{0}),//ÊÀ½çÖ®´°    
		LinkItem(0,TEXT("TTRAVELER.EXE"),{0}),//ÌÚÑ¶TT    
	};*/
}
